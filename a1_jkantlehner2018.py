...
# Contributors: Daniel Ramirez, John Kantlehner
...
class Board():
    ...
    # Sets the game state to an empty board
    ...
    # Returns true if a draw has occured
    def checkTie(self):
    ...
    # Sets board attribute board.winner to the winner of the game and returns true if there is a winner
    def CheckWin(self):
    ...
    # Resets the board, winner, and game mode
    def playAgain(self):
    ...
    # Takes, validates, and sets player move onto the board
    ...
    # Prompts the user to choose between 3 modes of play where the player can play against another player, a random choice computer, or a MinMax AI
    def pickMode(self):
    ...
    # Methods for MinMax AI Game Mode for Player vs MinMax AI (PvM)
    ...
    # Implementing Recursive Minimax Algorithm
    ...
    # Prints game info and instructions
    def info(self):
        # Print intro message, rules, instructions
        intro_message = "* * * * * * * * * * * * * * * * * * * * * * * * * * * Tic-Tac-Toe * * * * * * * * * * * * * * * * * * * * * * * * * * * *\n"
        game_rules = "- Rules: The first player to complete 3 of their marks in a row (vertically, horizontally, or diagonally) is the winner."
    ...
    # Facilitates Game Mode Selection and Initialization
    def game(self):    
        # print board example
        board_example = '0' + ' | ' + '1' + ' | ' + '2' + '\n' + '---------\n' + '3' + ' | ' + '4' + ' | ' + '5' + '\n' + '---------\n' + '6' + ' | ' + '7' + ' | ' + '8' + '\n'
        print(board_example + '\n')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        board.playAgain()  # ask player if they want to play again, if not exit game
